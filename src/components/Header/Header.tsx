const Header = () => {
    return (
        <div className={"header w-full relative"}>
            <div className="header-content text-white w-full p-5 md:p-0 relative bottom-0   md:absolute md:bottom-[10%] md:left-[6vw] flex flex-col items-start md:max-w-[50%] gap-[1.5vw]">
